...
#==============================================================================#
                if text.lower() == 'help':
                    ...
                    gye.sendContact(to, "u94c44a5c619f7bbab60a3375bfa4c907")
                    gye.sendMessage(to,"🇹🇷ÖＮＣＥ ＶＡＴＡＮ🇹🇷\n")
...
#==============================================================================#
                    ...
                    start = time.time()
                    gye.sendMessage(to, "уυкℓєиιуσя...")
                    elapsed_time = time.time() - start
                    gye.sendMessage(to,format(str(elapsed_time)))
                elif text.lower() == 'restart':    
                    gye.sendMessage(to, "lütfen bekleyin...")
                    time.sleep(5)
                    gye.sendMessage(to, "Reset atildi..")
                    restartBot()
                    ...
                    try:
                        arr = []
                        owner = "u94c44a5c619f7bbab60a3375bfa4c907"
...
#-------------------------------------------------------------------------------
                ...
                #    if msg._from in Owner:
                        if admin == []:
                            ...
                            gye.sendMessage(msg.to,"yükleniyor...")
                            mc = "╔═══════════════\n╠🇹🇷N⃟O⃟Y⃟A⃟N⃟ S⃟R⃟T⃟ B⃟O⃟T⃟S⃟\n╠══✪〘 A⃟D⃟M⃟İN⃟ L⃟İS⃟T⃟〙✪═══\n"
                            for mi_d in admin:
                                mc += "╠✪ " +gye.getContact(mi_d).displayName + "\n"
                            gye.sendMessage(msg.to,mc + "╠═══════════════\n╠✪〘 line.me/ti/p/~xnoyanx 〙\n╚═══════════════")
...
#-------------------------------------------------------------------------------
                        ...
                        gye.sendMessage(msg.to,"➲ 🇹🇷A⃟S⃟K⃟E⃟R⃟ 1")
                        ais.sendMessage(msg.to,"➲ 🇹🇷A⃟S⃟K⃟E⃟R⃟  2")
                        ki2.sendMessage(msg.to,"➲ 🇹🇷 A⃟S⃟K⃟E⃟R⃟  3")
                        ki3.sendMessage(msg.to,"➲ 🇹🇷 A⃟S⃟K⃟E⃟R⃟ 4")
                        ki4.sendMessage(msg.to,"➲ 🇹🇷A⃟S⃟K⃟E⃟R⃟  5")
                        gye.sendMessage(msg.to,"➲ Asker Sayisi tamam🖕")
